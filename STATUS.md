...
- 🟢 **零漂移前置:護欄 fixture 移除戶外座位(未 push)**:`cafe-menu-test.ts` 的 `matureUpgrades`
  是護欄「產能腿不投資 ⇒ 研發到不了淨租金一半」的 fixture,卻持有戶外座位;下一批要把戶外座位
  改成產能投資,前提會自己破掉。移除**逐位元零漂移**($326.214286 / $460.910714、客流 36.000000)。
