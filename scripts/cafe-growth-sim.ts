...
//   - 大型冷藏($10,000,原 $15,000):照建議量備貨時仍然近乎 0(成熟 13,333 天、
//     名店 549.6 天)—— 那是**正確的**,它是保險 + 冷萃閘門,判準改用「備貨過量情境」
//     (該情境下成熟 168.1 天、名店 62.6 天,兩格都在 60~250 帶內),見上方那張兩情境表。
//     **不納入【E】**(它不是產能,買它不會多做一單)。
