...
const REGRESSION = [
  ...
  "balance-test.ts", "bathroom-life-test.ts", "bugfix2-test.ts", "cafe-guest-test.ts", "cafe-map-test.ts", "cafe-stair-art-test.ts", "cohabit-integrity-test.ts", "comfort-test.ts", "communal-comfort-test.ts", "community-test.ts", "conflict-test.ts", "content-variety-test.ts", "couple-departure-test.ts", "data-catalog-test.ts",
