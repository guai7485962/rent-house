...
const REGRESSION = [
  ...
  "distinct-test.ts", "drama-test.ts", "dream-test.ts", "eviction-test.ts", "feed-test.ts", "finance-test.ts", "fixes-test.ts", "floor-chain-test.ts", "floor-view-test.ts", "fx-test.ts", "gender-rel-test.ts",
