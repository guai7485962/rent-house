...
const REGRESSION = [
  ...
  "move-test.ts", "name-pet-rate-test.ts", "narrative-quality-test.ts", "observation-test.ts", "outing-test.ts", "pair-session-test.ts", "pet-test.ts", "qol-test.ts", "relist-test.ts", "romance-integrity-test.ts",
