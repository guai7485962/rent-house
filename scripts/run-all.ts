...
const REGRESSION = [
  ...
  "rent-test.ts", "roomcam-test.ts", "rotation-pose-test.ts", "shop-venue-test.ts", "stats-model-test.ts", "summary-test.ts", "vacuum-test.ts", "wallet-test.ts", "weather-test.ts", "week-test.ts", "weekly-report-test.ts", "wish-test.ts", "worker-test.ts",
];
