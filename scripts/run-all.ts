...
const REGRESSION = [
  "acoustics-laundry-test.ts", "ai-event-quality-test.ts", "ai-interaction-test.ts", "appearance-test.ts", "arc-test.ts", "arc-variety-test.ts", "arc-variety-p23-test.ts", "archetypes-test.ts",
  "balance-test.ts", "bathroom-life-test.ts", "bugfix2-test.ts", "cafe-abandon-test.ts", "cafe-adoption-test.ts", "cafe-at-cafe-test.ts", "cafe-bottleneck-test.ts", "cafe-daily-test.ts", "cafe-furniture-test.ts", "cafe-gathering-test.ts", "cafe-guest-agent-test.ts", "cafe-guest-test.ts", "cafe-intent-bubble-test.ts", "cafe-interactions-test.ts", "cafe-map-test.ts", "cafe-menu-test.ts", "cafe-narrate-ctx-test.ts", "cafe-p2-flow-test.ts", "cafe-panel-collapse-test.ts", "cafe-p3-economy-test.ts", "cafe-p4a-growth-test.ts", "cafe-p4b-staff-test.ts", "cafe-per-guest-test.ts", "cafe-pet-agent-test.ts", "cafe-recipe-clarity-test.ts", "cafe-regular-test.ts", "cafe-rent-intent-test.ts", "cafe-research-test.ts", "cafe-seat-pose-test.ts", "cafe-stair-art-test.ts", "cafe-state-test.ts", "cafe-supply-test.ts", "cafe-upgrade-test.ts", "cafe-venue-effect-test.ts", "cafe-zone-guide-test.ts", "cafe-zones-test.ts", "cohabit-integrity-test.ts", "comfort-test.ts", "communal-comfort-test.ts", "community-test.ts", "conflict-test.ts", "content-variety-test.ts", "couple-departure-test.ts", "data-catalog-test.ts",
  "daynight-test.ts", "debug-export-test.ts", "diary-queue-test.ts", "diary-stagger-test.ts", "diary-upgrade-test.ts", "directive-test.ts",
  "distinct-test.ts", "drama-test.ts", "dream-test.ts", "eviction-test.ts", "feed-test.ts", "finance-test.ts", "fixes-test.ts", "floor-chain-data-test.ts", "floor-chain-test.ts", "floor-view-test.ts", "fx-test.ts", "gender-rel-test.ts",
  "furniture-art-test.ts", "furniture-tier-test.ts", "group-scene-test.ts", "interaction-pool-test.ts", "interactions-test.ts", "invite-test.ts", "kindness-test.ts", "kitchen-life-test.ts", "legacy-test.ts", "limezu-art-test.ts", "living-experience-test.ts", "local-arc-test.ts", "maintenance-test.ts", "memory-lifecycle-test.ts", "relationship-tension-test.ts",
  "move-test.ts", "name-pet-rate-test.ts", "neglect-test.ts", "narrate-resilience-test.ts", "narrative-quality-test.ts", "observation-test.ts", "ops-panel-test.ts", "outing-test.ts", "pair-pose-test.ts", "pair-session-test.ts", "pet-photo-test.ts", "pet-test.ts", "qol-test.ts", "relist-test.ts", "romance-integrity-test.ts",
  "rent-test.ts", "roomcam-test.ts", "rotation-pose-test.ts", "scuffle-pose-test.ts", "shop-cat-test.ts", "shop-venue-test.ts", "stats-model-test.ts", "summary-test.ts", "triangle-test.ts", "vacuum-test.ts", "wallet-test.ts", "weather-test.ts", "week-test.ts", "weekly-report-test.ts", "wish-test.ts", "worker-test.ts",
];
