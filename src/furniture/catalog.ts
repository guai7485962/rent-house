...
export const CATALOG: FurnitureDef[] = [
  ...
  },
  {
    ...
    social: false,
    effectHint: "睡眠恢復 ×1.00 · 平價基本款,睡飽得花時間",
    promptHints: ["賴床到中午"],
    sprite: { kind: "bed" },
  },
  {
    ...
    unlocksStates: ["sleeping_on_bed"],
    social: false,
    effectHint: "睡眠恢復 ×1.12 · 換了大床之後睡得更沉",
  ...
  },
  {
    ...
    unlocksStates: ["sleeping_on_bed"],
    social: false,
    effectHint: "睡眠恢復 ×1.22 · 睡得最安穩,累垮時恢復也最快",
  ...
  // =========================================================================
  {
    ...
    unlocksStates: ["sleeping_on_bed"],
    social: false,
    effectHint: "睡眠恢復 ×1.00 · 平價入門款,睡得著但不特別舒服",
  ...
  // =========================================================================
  // 1F 寵物咖啡廳家具(CAFE-06)
  //   只能 append；不進 INITIAL_PLACEMENTS，避免既有租客的 resolveTarget 靜默改道。
  //   placement 沿用 communal 才能放進 cafe region，但不解鎖租客 visualState；租客正式
  //   下樓要等 CAFE-20 的 CAFE_FIRST_DAY 閘門。atlas 未載入時由 recipe 完整接手。
  // =========================================================================
  {
    id: "cafe_counter",
    tier: "premium",
    ...
    footprint: { w: 2, h: 1 },
    interact: { dc: 0, dr: 1 },
    attributes: { style: 4, storage: 2 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["吧台上排著今天剛擦亮的杯子", "客人在點餐口猶豫要不要加一份甜點"],
    sprite: {
      recipe: [
        { shape: "block", x: 1, y: 5, w: 30, h: 10, color: "#a85f70", top: 3 },
        { shape: "rect", x: 2, y: 5, w: 28, h: 2, color: "#e3a1ac" },
        { shape: "rect", x: 21, y: 2, w: 7, h: 4, color: "#4b4658" },
      ],
    },
  },
  {
    ...
    footprint: { w: 1, h: 1 },
    interact: { dc: 0, dr: 1 },
    attributes: { tech: 3, style: 2 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["蒸氣棒嘶嘶作響", "第一杯濃縮咖啡的香氣把店裡叫醒"],
    sprite: {
      recipe: [
        { shape: "block", x: 2, y: 2, w: 12, h: 13, color: "#c8cbd1", top: 2 },
        { shape: "rect", x: 4, y: 5, w: 8, h: 3, color: "#383b49" },
        { shape: "rect", x: 5, y: 10, w: 6, h: 3, color: "#eee2cd" },
      ],
    },
  },
  {
    ...
    footprint: { w: 1, h: 2 },
    interact: { dc: 1, dr: 1 },
    attributes: { storage: 3, style: 3 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["玻璃櫃裡的蛋糕剛補滿", "最後一塊布丁被客人指走"],
    sprite: {
      recipe: [
        { shape: "block", x: 1, y: 3, w: 14, h: 28, color: "#d98ca0", top: 2 },
        { shape: "rect", x: 3, y: 6, w: 10, h: 17, color: "#dcecf0" },
        { shape: "rect", x: 3, y: 12, w: 10, h: 1, color: "#a6b9c1" },
        { shape: "rect", x: 3, y: 18, w: 10, h: 1, color: "#a6b9c1" },
      ],
    },
  },
  {
    ...
    unlocksStates: [],
    social: false,
    promptHints: ["粉筆字寫著今日限定", "菜單角落多了一隻歪歪的貓爪"],
    sprite: {
      recipe: [
        { shape: "block", x: 2, y: 2, w: 28, h: 28, color: "#a65d75", top: 2 },
        { shape: "rect", x: 5, y: 6, w: 22, h: 18, color: "#f4dfeb" },
        { shape: "rect", x: 8, y: 9, w: 16, h: 2, color: "#b76c85" },
        { shape: "rect", x: 8, y: 14, w: 12, h: 2, color: "#b76c85" },
      ],
    },
  },
  {
    ...
    unlocksStates: [],
    social: false,
    promptHints: ["桌邊留著兩杯喝到一半的咖啡"],
    sprite: {
      recipe: [
        { shape: "block", x: 2, y: 4, w: 12, h: 9, color: "#d99aa8", top: 2 },
        { shape: "rect", x: 7, y: 13, w: 2, h: 12, color: "#72525c" },
        { shape: "rect", x: 4, y: 25, w: 8, h: 3, color: "#72525c" },
      ],
    },
  },
  {
    ...
    footprint: { w: 1, h: 1 },
    interact: { dc: 0, dr: 1 },
    attributes: { cozy: 1, style: 1 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["椅背掛著客人暫放的外套"],
    sprite: {
      recipe: [
        { shape: "block", x: 3, y: 4, w: 10, h: 8, color: "#cb8799", top: 2 },
        { shape: "rect", x: 4, y: 12, w: 2, h: 4, color: "#6e4b55" },
        { shape: "rect", x: 10, y: 12, w: 2, h: 4, color: "#6e4b55" },
      ],
    },
  },
  {
    ...
    unlocksStates: [],
    social: false,
    promptHints: ["椅子被轉向寵物遊戲區"],
    sprite: {
      recipe: [
        { shape: "block", x: 5, y: 4, w: 8, h: 8, color: "#b8778b", top: 2 },
        { shape: "rect", x: 4, y: 5, w: 2, h: 10, color: "#6e4b55" },
        { shape: "rect", x: 11, y: 12, w: 2, h: 4, color: "#6e4b55" },
      ],
    },
  },
  {
    ...
    footprint: { w: 2, h: 2 },
    interact: { dc: 2, dr: 1 },
    attributes: { cozy: 5, style: 3 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["最高的平台被貓咪輪流佔領", "垂掛玩具晃個不停"],
    sprite: {
      recipe: [
        { shape: "block", x: 3, y: 23, w: 26, h: 8, color: "#b88b68", top: 2 },
        { shape: "rect", x: 7, y: 8, w: 4, h: 17, color: "#8b684f" },
        { shape: "rect", x: 21, y: 4, w: 4, h: 21, color: "#8b684f" },
        { shape: "block", x: 3, y: 5, w: 13, h: 6, color: "#c9a47e", top: 2 },
        { shape: "block", x: 17, y: 1, w: 12, h: 6, color: "#c9a47e", top: 2 },
      ],
    },
  },
  {
    ...
    unlocksStates: [],
    social: false,
    promptHints: ["軟墊上沾著幾根曬暖的毛"],
    sprite: {
      recipe: [
        { shape: "rect", x: 2, y: 6, w: 28, h: 8, color: "#739d8a" },
        { shape: "rect", x: 4, y: 7, w: 24, h: 5, color: "#9fc1ad" },
        { shape: "rect", x: 7, y: 8, w: 4, h: 2, color: "#d7eadc" },
      ],
    },
  },
  {
    ...
    footprint: { w: 2, h: 1 },
    interact: { dc: 0, dr: 1 },
    attributes: { storage: 6 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["咖啡豆與紙杯按日期排得整整齊齊"],
    sprite: {
      recipe: [
        { shape: "block", x: 1, y: 2, w: 30, h: 13, color: "#65717b", top: 2 },
        { shape: "rect", x: 3, y: 6, w: 26, h: 2, color: "#94a0aa" },
        { shape: "rect", x: 3, y: 11, w: 26, h: 2, color: "#94a0aa" },
        { shape: "rect", x: 5, y: 3, w: 6, h: 3, color: "#c69462" },
        { shape: "rect", x: 18, y: 8, w: 7, h: 3, color: "#d4b372" },
      ],
    },
  },
  {
    ...
    footprint: { w: 1, h: 1 },
    interact: { dc: 0, dr: 1 },
    attributes: { storage: 2 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["剛送到的木箱還貼著進貨單"],
    sprite: {
      recipe: [
        { shape: "block", x: 2, y: 4, w: 12, h: 11, color: "#a9784f", top: 2 },
        { shape: "rect", x: 4, y: 7, w: 8, h: 2, color: "#d2a06d" },
        { shape: "rect", x: 7, y: 5, w: 2, h: 9, color: "#7d563b" },
      ],
    },
  },
  {
    ...
    footprint: { w: 1, h: 2 },
    interact: { dc: 1, dr: 1 },
    attributes: { storage: 6, tech: 2 },
    fitsTags: [],
    unlocksStates: [],
    social: false,
    promptHints: ["冷藏櫃裡的牛奶與鮮食分層擺好", "壓縮機在後場低聲運轉"],
    sprite: {
      recipe: [
        { shape: "block", x: 2, y: 1, w: 12, h: 30, color: "#bcc8ce", top: 2 },
        { shape: "rect", x: 4, y: 5, w: 8, h: 10, color: "#7896a4" },
        { shape: "rect", x: 4, y: 18, w: 8, h: 9, color: "#7896a4" },
        { shape: "rect", x: 11, y: 12, w: 1, h: 4, color: "#e7eef0" },
      ],
    },
  },
];
